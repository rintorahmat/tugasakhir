...
async def process(file_id: int):
    try:
        ...
        new_data = data[['content', 'Translated', 'Space', 'DeleteEmotikon', 'HapusTandaBaca','LowerCasing', 'Tokenizing', 'Stemmed', 'StopWord' , 'NilaiAktual', 'SentimentLabel', 'Polarity'  ]]
...
async def sentimenanalis(file_id: int):
    try:
        ...
        new_data = data[['Stemmed', 'NilaiAktual', 'SentimentLabel', 'Polarity'  ]]
        save_preprocessed_data(new_data)
